          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="p-6 pb-20">
                ...
                <p className="mt-2 text-sm text-indigo-600 font-medium capitalize">
              ...
              <div className="absolute bottom-6 right-6 z-20">
                <div className="w-12 h-12 flex items-center justify-center rounded-full bg-indigo-600 text-white shadow-xl transition-all duration-300 transform group-hover:scale-110 group-hover:shadow-indigo-500/50 hover:bg-indigo-700">
